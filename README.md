...
```
cd existing_repo
git remote add origin https://gitlab.socs.uoguelph.ca/cis3760f24/shuigraph/crapmap.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.socs.uoguelph.ca/cis3760f24/shuigraph/crapmap/-/settings/integrations)
